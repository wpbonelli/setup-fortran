...
| ubuntu-24.04   | &check;         | &check;         |              | &check;               | &check;                 | &check;               | &check;               | &check;               | &check;               | &check;               | &check;                 | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               | &check;                       | &check;                         | &check;                       |                            | &check;                       | &check;                       | &check;                       | &check;                         | &check;                       | &check;                       | &check;                        | &check;                        | &check;                        | &check;                  | &check;                  | &check;                   |                        |                        |                       |                       |                       |                       |                        |                       |                       | &check;                  | &check;                  |
| windows-2022   |              | &check;         | &check;         |                    |                      |                    |                    |                    | &check;               | &check;               |                      |                    | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               |                            |                              |                            |                            |                            |                            | &check;                       |                              |                            | &check;                       | &check;                        | &check;                        | &check;                        | &check;                  | &check;                  |                        |                        |                        |                       |                       |                       |                       |                        |                       |                       |                       |                       |
| windows-2025   |              |              | &check;         |                    |                      |                    |                    |                    | &check;               | &check;               |                      |                    | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               |                            |                              |                            |                            |                            |                            | &check;                       |                              |                            | &check;                       | &check;                        | &check;                        | &check;                        | &check;                  | &check;                  |                        |                        |                        |                       |                       |                       |                       |                        |                       |                       |                       |                       |
<!-- compat ends -->
