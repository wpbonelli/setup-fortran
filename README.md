...
| macos-15       |                  | &check;         | &check;         | &check;         |                    |                      |                    |                    |                    |                    |                    |                      |                    |                    |                    |                    |                    |                    |                    | &check;                       |                              | &check;                       | &check;                       |                            | &check;                       | &check;                       |                              | &check;                       | &check;                       | &check;                        |                             |                             | &check;                  | &check;                  |                       |                       |                       |                       |                        |                       |                       |                       |                       |                       |                       |                       |                       |                       |
| macos-15-intel |                  | &check;         | &check;         | &check;         | &check;               |                      | &check;               |                    |                    |                    |                    |                      |                    |                    |                    |                    |                    |                    |                    | &check;                       |                              | &check;                       | &check;                       |                            | &check;                       | &check;                       |                              | &check;                       | &check;                       | &check;                        |                             |                             | &check;                  | &check;                  |                       |                       |                       |                       |                        |                       |                       |                       |                       |                       |                       |                       |                       |                       |
| macos-26       |                  | &check;         | &check;         | &check;         |                    |                      |                    |                    |                    |                    |                    |                      |                    |                    |                    |                    |                    |                    |                    | &check;                       |                              | &check;                       | &check;                       |                            | &check;                       | &check;                       |                              | &check;                       | &check;                       | &check;                        |                             |                             | &check;                  | &check;                  |                       |                       |                       |                       |                        |                       |                       |                       |                       |                       |                       |                       |                       |                       |
| macos-26-intel |                  | &check;         | &check;         | &check;         | &check;               |                      | &check;               |                    |                    |                    |                    |                      |                    |                    |                    |                    |                    |                    |                    | &check;                       |                              | &check;                       | &check;                       |                            | &check;                       | &check;                       |                              | &check;                       | &check;                       | &check;                        |                             |                             | &check;                  | &check;                  |                       |                       |                       |                       |                        |                       |                       |                       |                       |                       |                       |                       |                       |                       |
| ubuntu-22.04   |                  | &check;         |              |              | &check;               | &check;                 | &check;               | &check;               | &check;               | &check;               | &check;               | &check;                 | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               | &check;                       | &check;                         | &check;                       |                            | &check;                       | &check;                       | &check;                       | &check;                         | &check;                       | &check;                       | &check;                        | &check;                        | &check;                        | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                   | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  |
| ubuntu-24.04   | &check;             |              |              |              | &check;               | &check;                 | &check;               | &check;               | &check;               | &check;               | &check;               | &check;                 | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               | &check;               | &check;                       | &check;                         | &check;                       |                            | &check;                       | &check;                       | &check;                       | &check;                         | &check;                       | &check;                       | &check;                        | &check;                        | &check;                        | &check;                  | &check;                  |                       |                       |                       |                       |                        |                       |                       | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  | &check;                  |
